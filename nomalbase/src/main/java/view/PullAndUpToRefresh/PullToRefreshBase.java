 ...
 *******************************************************************************/
package view.PullAndUpToRefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean isRefreshing() {
        return mState == State.REFRESHING || mState == State.MANUAL_REFRESHING || isFooterRefreshing();
    }
...
//        }
    ...
    public static enum AnimationStyle {
         ...
         * @return Mode that modeInt maps to, or TRANSLATE by default.
         */
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case TRANSLATE:
                default:
                    return new TranslateLoadingLayout(context, mode, scrollDirection, attrs);
                case FLIP:
